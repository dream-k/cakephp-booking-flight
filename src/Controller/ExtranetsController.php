...
//Check write Access to Directory
    ...
    public function bookings() {
        ...
        if (empty($_GET['q']) || $_GET['q'] == 'all') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['property_user_id' => $userID])->sumOf('total_cost');
        ...
        if (!empty($_GET['q']) && $_GET['q'] == 'today') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['booking_dt' => date('Y-m-d'), 'property_user_id' => $userID])->sumOf('total_cost');
        ...
        if (!empty($_GET['q']) && $_GET['q'] == 'yesterday') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['booking_dt' => date('Y-m-d', strtotime('-1 days')), 'property_user_id' => $userID])->sumOf('total_cost');
        ...
        if (!empty($_GET['q']) && $_GET['q'] == 'weekly') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['booking_dt >=' => date('Y-m-d', strtotime('-7 days')), 'booking_dt <=' => date('Y-m-d'), 'property_user_id' => $userID])->sumOf('total_cost');
        ...
        if (!empty($_GET['q']) && $_GET['q'] == 'monthly') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['MONTH(booking_dt)' => date('m-Y'), 'property_user_id' => $userID])->sumOf('total_cost');
        ...
        if (!empty($_GET['q']) && $_GET['q'] == '6month') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['booking_dt >=' => date('Y-m-d', strtotime('-7 months')), 'booking_dt <=' => date('Y-m-d', strtotime('-1 months')), 'property_user_id' => $userID])->sumOf('total_cost');
        ...
        if (!empty($_GET['q']) && $_GET['q'] == '3month') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['booking_dt >=' => date('Y-m-d', strtotime('-4 months')), 'booking_dt <=' => date('Y-m-d', strtotime('-1 months')), 'property_user_id' => $userID])->sumOf('total_cost');
        ...
        if (!empty($_GET['q']) && $_GET['q'] == 'yearly') {
            ...
            $getBookingPrice = $this->HotelBookingDetails->find('all')->where(['YEAR(booking_dt)' => date('Y'), 'property_user_id' => $userID])->sumOf('total_cost');
...
';
        ...
        $this->HotelBookingDetails->updateAll(['check_in' => date_format(date_create(str_replace('/', '-', $data['checkIn'])), 'Y-m-d'), 'check_out' => date_format(date_create(str_replace('/', '-', $data['checkOut'])), 'Y-m-d')], ['booking_no' => $data['id']]);
        echo json_encode(['status' => 'success']);
        exit;
    }

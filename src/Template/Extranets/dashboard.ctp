    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h1><?php echo __('Welcome back'); ?>, <?= $user_datass->first_name; ?>!</h1>
...
<?php if ($user_datass->profile_photo != "") { ?> <img src='<?= HTTP_ROOT . $user_datass->profile_photo; ?>' alt="usr" width="90" style="border-radius: 50%;"><?php } else { ?> <i class="fa fa-user" aria-hidden="true"></i><?php } ?>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 host-profile-middle">
                                        <div class="host-profile-left"><i class="fa fa-clock" aria-hidden="true"></i> Last Login: 10 April 2019</div>
                                    </div>
                                </div>
...
<?= $this->Form->create('', ['type' => 'post']); ?>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div id="Profile-property">
                    <div>
                        <div id="cropContainerModal"><?php if ($user_datass->profile_photo != "") { ?> <img src='<?= HTTP_ROOT . $user_datass->profile_photo; ?>' alt="usr" style="width: 180px;border-radius: 50%;"><?php } else { ?><i class="fas fa-user-circle" style='font-size: 40px;'></i><?php } ?></div>

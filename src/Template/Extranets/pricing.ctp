                         ...
                         @$propPri = $this->User->proPrice($id, $val->id);
                            ...
                            <div class="panel panel-default price-configuration m-t-3">
                                <div class="panel-body">
                                    <div></div>
                                    <h4>
                                        <?= $val->bed_name; ?> <?php echo __('can accommodate up to'); ?> <?= $accomo = $this->User->getAccomodation($val->id); ?> <?php if($accomo==1){ echo __('person'); } else { echo __('people');} ?>.<strong class="text-uppercase">

            ...
            <div class="col-sm-8 col-lg-9">
                ...
                <div class="boking_Box" style="">
                    ...
                    <div class="input-group">
                        ...
                        <textarea class="form-control custom-control" name="notifi_msg" rows="5" placeholder="Write a message..." style="resize:none"></textarea> 
                    ...
                    <div style="width:100%;">
                        <button type="submit" class="btn btn-primary" style="margin-top: 10px;width: 10% !important;float: right;">Send</button>
                    </div>
                    <?= $this->Form->end(); ?>
                </div>
            </div>

    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8 col-lg-9">
                ...
                <?php if (@$result_property_count != 0) { ?>
                        ...
                        foreach ($result_property as $list) {
                            ...
                            <div class="hotel-lsting">
                                ...
                                <div class="hotel-lsting-middle" style="width: 48%;">
                                    ...
                                    <?php if ($list->description->rating >= 4) { ?><h5 style="background-color:#8bc34a !important;font-size: 15px;width: 62%;margin-top: -3px;text-transform: capitalize;"><a href="#"><?php echo __('High Quality'); ?></a></h5> 
                                    <?php } else if ($list->description->rating >= 3) { ?><h5 style="background-color: #ffc107 !important;font-size: 15px;width: 62%;margin-top: 12px;text-transform: capitalize;"><a href="#"><?php echo __('Medium Quality') ?></a></h5> 
                                    <?php } else if ($list->description->rating <= 2) { ?><h5 style="background-color: #f44336 !important;font-size: 15px;width: 62%;margin-top: -3px;text-transform: capitalize;"><a href="#"><?php echo __('Low Quality') ?></a></h5> <?php } ?>
                                </div>
                                <div class="hotel-lsting-right">
                                    <h6><?php echo $this->User->reviewCount($list->id); ?> <?php echo __('reviews') ?><span><?php echo is_nan($this->User->totalRating($list->id))?0:$this->User->totalRating($list->id); ?></span></h6>

                                    <h5 class="old-price">
                                        <?php if ($htl_rm_pric_frea > 0) { ?>
                                            <span><?php echo __('was') ?></span><span>AOA <?= changeFormat(number_format($htl_rm_pric, 2)); ?>/<?php echo __('night') ?></span>
                                            <?php
                                        } else {
                                            echo "&nbsp;&nbsp;";
                                        }

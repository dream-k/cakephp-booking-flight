                ...
                <div class="reasons-book-left">
                    <div class="rait-bg">
                        <div class="rait-bg-text">
                            <?php echo $this->User->totalRating($result_property->id); ?>
                        </div>
                                                    ...
                                                    <div class="non-refund-price" style="float:right">
                                                        <h5 class="old-price">
                                                            <?php if ($htl_rm_pric_frea > 0) { ?>
                                                                <span><?php echo __('was') ?></span><span>AOA <?= changeFormat(number_format($htl_rm->pricing->price_main, 2)); ?>/<?php echo __('night') ?></span>
                                                                <?php
                                                            } else {
                                                                echo "&nbsp;&nbsp;";
                                                            }

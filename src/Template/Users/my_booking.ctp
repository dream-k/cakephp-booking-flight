...
<style type="text/css">
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <div class="row flight-details-header">
                                                                ...
                                                                <div class="col-md-5 col-6 offset-lg-1 text-right">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <div class="flight-details-price"> AOA <?php
                                                                                $dprice = explode('AOA', $details->price);
                                                                                echo $this->User->changeFormat(number_format($dprice[1], 2));
                                                                                ?> </div>
                                                                        </div>
    ...
    <?php if (date('Y-m-d') <= date_format($pro_book->check_out, 'Y-m-d')) { ?>
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <button onclick="modal_open(<?= $pro_book->property_id; ?>, '<?= $pro_book->booking_no; ?>', '<?= $this->User->usrHelper($pro_book->property_user_id)->name; ?>', '<?= HTTP_ROOT . $this->User->usrdetHelper($pro_book->property_user_id)->profile_photo; ?>',<?= $pro_book->id; ?>)" type="button" class="btn btn-primary hvr-grow btn-fill" >Review</button>
                                                    <?php } ?>
                                                        </div>
                                                    </div>
                                                    </div>
                                                        ...
                                                        <div class="modal-dialog modal-confirm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p class="text-center">Your feedback has been successfully sent to the property. By sharing your honest feedback, you help other guests know exactly how they will be treated.</p>
                                                                </div>
                                                                <div class="modal-footer" style="background:#fff;">
                                                                    <button class="btn btn-success btn-block" data-dismiss="modal" onclick='$("#review_down").hide();
                                                                                window.location.href = "<?= HTTP_ROOT; ?>my-booking";'>OK</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

...
<div class="se-pre-con"> 
        ...
        <div class="img-load-ing">
            ...
            <center>
                <span style="font-size: 2em; color:#000;">
                    <?php echo __('Please wait, while we load your next trip to') ?> <b><?= $this->User->cityHelper($ubd['destination'])->city; ?></b> (<?= $ubd['destination'] ?>) </span>
            </center>
        </div> 
    </div> 
    ...
    <div class="top-last" style="color: #000;text-align:  center; font-weight: bold;">
        ...
        <span style="font-size: 2em; color:#000;"><?= __(date("D, d M", strtotime(str_replace(',', ' ', $ubd['start_depart_time'])))); ?> <?php if (!empty($ubd['return_arrival_time'])) { ?>- <?= __(date("D, d M", strtotime(str_replace(',', ' ', $ubd['return_arrival_time'])))); ?> <?php } ?></span>
        <br>      
        <span style="font-size: 20px; color:#000;"><?php echo $ubd['passengers'];
                    echo ($ubd['passengers'] > 1) ? " Passenges" : " Passenger";
                    ?></span>
            ...
            <div class="col-sm-12 col-md-8 col-lg-12">
                ...
                <div class="searchItem d-flex">
                    ...
                    <div class="bookBtn text-center">
                        <span>AOA <?= $this->User->changeFormat(number_format($price1, 2)); ?></span>
                    ...
                    <table style="margin-left: 27px;width: 645px;margin-top: -15px;">
                        ...
                        <tbody>
                            <tr style="
                                ...
                                <td style="width: 253px;border-bottom: 2px solid #eeeeee;text-transform: uppercase;">AOA <?php $priceperperson = $mainprice;
echo $this->User->changeFormat(number_format($priceperperson, 2)); ?></td>
                            </tr>
                            <tr style="">
                                ...
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;font-weight:bold;"></td>
                                <td style="width: 566px;border-top: 2px solid #eeeeee;border-bottom: 1px solid #eeeeee; text-transform: uppercase;">AOA <?php

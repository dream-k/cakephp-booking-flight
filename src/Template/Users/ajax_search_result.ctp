...
<div class="se-pre-con"> 
    ...
    <div class="top-last" style="color: #000;text-align:  center; font-weight: bold;">
        <span style="font-size: 2em; color:#000;"><?= __(date("D, d M", strtotime(str_replace('/', '-', $_GET['departure_date'])))); ?> <?php if ($_GET['radio'] != "One-Way Flight") { ?>- <?= __(date("D, d M", strtotime(str_replace('/', '-', $_GET['return_date'])))); ?> <?php } ?></span>  <br>      
        <span style="font-size: 20px; color:#000;"><?= __($_GET['passenger']); ?></span>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row flight-details-header">
                                                ...
                                                <div class="col-md-3 col-6 offset-lg-1 text-right">
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="flight-details-price"> AOA <?php echo $this->User->changeFormat(number_format(explode('AOA', $resut->price)[1], 2)); ?> </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">

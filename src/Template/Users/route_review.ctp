                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email" required="required" placeholder="Enter Email Address" value="<?php
                ...
                <table style="margin-left: 27px;width: 283px;margin-top: -15px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 401px;border-bottom: 1px solid #eeeeee;text-transform: uppercase;">AOA <?php $priceperperson = $mainprice;
                        ...
                        <tr>
                            ...
                            <td style="width: 244px;border-bottom: 1px solid #eeeeee;text-transform: uppercase;">AOA <?php
if ($this->User->cityHelper($fligh_det['origin'])->country == "Angola" && $this->User->cityHelper($fligh_det['destination'])->country == "Angola") {

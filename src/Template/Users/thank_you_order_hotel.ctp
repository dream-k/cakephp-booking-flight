            ...
            <div class="col-sm-12 col-md-8 col-lg-12">
                ...
                <div class="hotel-lsting" style="margin: 82px 0px;">
                    ...
                    <div class="hotel-lsting-middle">
                        ...
                        <p style="margin-top: 16px;margin-bottom: -9px !important;"><?= $propertyD->property_size; ?> <?php echo __('Sqm'); ?></p>
                        <p style="margin-bottom: -9px !important;"><?php echo $getBetDetails->num_bed; ?>x <?php echo __($getBetDetails->beds); ?>  <?php foreach ($getBetDetails->extranets_user_property_sub_beds as $bes) { ?> <?php echo " + " . $bes->num_beds ?>x <?php
                                echo __($bes->beds);
                            }
                            ?></p>
                        <p style="margin-bottom: 0 !important;">  <?php
                        ...
                        <?php if ($propertyD->description->rating >= 4) { ?><h5 style="margin: 20px 0px 11px 10px;background-color:#8bc34a !important;"><a href="#"><?php echo __('High Quality') ?></a></h5> 
                        <?php } else if ($propertyD->description->rating >= 3) { ?><h5 style="margin: 20px 0px 11px 10px;background-color: #ffc107 !important;"><a href="#"><?php echo __('Medium Quality') ?></a></h5> 
                        <?php } else if ($propertyD->description->rating <= 2) { ?><h5 style="margin: 20px 0px 11px 10px;background-color: #f44336 !important;"><a href="#"><?php echo __('Low Quality') ?></a></h5> <?php } ?>
                    </div>
                    <div class="hotel-lsting-right">
                        <h6><?php echo $this->User->reviewCount($pro_id); ?> <?= __("reviews"); ?><span><?php echo is_nan($this->User->totalRating($pro_id))?0:$this->User->totalRating($pro_id); ?></span></h6>

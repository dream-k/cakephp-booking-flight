...
if ($res_found == 0) {
    ...
    foreach ($search_det_dats as $resut) {
        ...
        <?php if ($resut->refundable == "true") { ?><p class="btn btn-primary"><img src="<?= $this->Url->image('dollar.png'); ?>" width="25"> <?php echo __('Refundable'); ?></p><?php } else if ($resut->refundable == "false") { ?><p class="btn btn-primary"><img src="<?= $this->Url->image('dollar.png'); ?>" width="25"> <?php echo __('Non-Refundable'); ?></p><?php } ?>
                <span>AOA <?php echo $this->User->changeFormat(number_format(explode('AOA', $resut->price)[1], 2)); // $resut->price;  ?></span>
                    ...
                    <div class="container">
                        ...
                        <div class="row flight-details-header">
                            ...
                            <div class="col-md-3 col-6 offset-lg-1 text-right">
                                <div class="row">
                                    <div class="col">
                                        <div class="flight-details-price"> AOA <?php echo $this->User->changeFormat(number_format(explode('AOA', $resut->price)[1], 2)); // $resut->price; ?> </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col text-left">
                                <div class="flight-details-departure-title"> <?php echo __('DEPARTURE'); ?>: <?= $this->User->cityHelper($orr)->city; ?> - <?= $this->User->cityHelper($dess)->city; ?> </div>
                            </div>
                        </div>
                        <!-- Flight details row -->
        <?php
            ...
            ?>
                            <div class="row flight-details-row">
                                ...
                                <div class="col-md-3 col-4 flight-details-duration text-center">
                                    ...
                                    <div class="row">
                                        <div class="col"> <?= $cabi; ?> <?php echo __('Cabin'); ?> </div>
                                    </div>
                                </div>
                            ...
                            <?php if ($ini != $jor_st_cn) { ?>
                                <div class="row">
                                    <div class="col text-center">
                                        <div class="flight-details-layover"> <?php echo __('Layover'); ?>: <span><?= $this->User->cityHelper($fli_de['destination'])->city; ?> (<?= $fli_de['destination']; ?>)</span> - Time: <?= dateDifference($this->User->flightdetails($resut->id)[$ini + 1]['dep_time'], $fli_de['arr_time']); ?> </div>
                                    </div>
                                </div>
                            <?php
                            }
        ...
        <?php if ($fli['jor_typ'] == "Journey Details Return") { ?>
                            ...
                            <div class="row">
                                <div class="col text-left">
                                    <div class="flight-details-departure-title"> <?php echo __('RETURN'); ?>: <?= $this->User->cityHelper($dess)->city; ?> - <?= $this->User->cityHelper($orr)->city; ?> </div>
                                </div>
                            </div>
                            <!-- Flight details row -->                  
        <?php } ?>

                    ...
                    <div class="aparthotel-left">
                        ...
                        <div class="billing">
                            ...
                            <div class="Mobile-Phone-Number" style="margin: 16px 226px -10px 2px;">
                                <?= __("Phone Number"); ?> 
                                <input  type="text" id="zip" name="mobile" placeholder="+244 923 480 978" required style="margin: 18px -365px 0px 0px; width: 365px;">  
                            </div>
                        ...
                        <input type="hidden" name="total_room_fee" value="<?= $ttfee = @$_GET['rooms'] * ($htl_pri * $dategap); ?>" />
                        <input type="hidden" name="total_tax" value="<?= $tt_tax = 0; ?>" />
                        <input type="hidden" name="total_cost" value="<?= $tt_cost = $ttfee + $tt_tax; ?>" />
                            ...
                            <div class="room-cost">
                                <ul>
                                    ...
                                    <li><?php echo __(@$_GET['rooms']); ?> <?php if ($_GET['rooms'] <= 1) { ?> <?php echo __('Room') ?> <?php } else { ?> <?php echo __('Rooms') ?> <?php } ?> x <?= $dategap; ?> <?php if ($dategap > 1) { ?> <?= __("nights"); ?>  <?php
                                        ...
                                        ?>
                                        <span>
                                            <?= changeFormat(number_format($ttfee, 2)); ?> AOA</span></li>
                                </ul>
                            </div>
                            <!--                            <div class="taxes-fees">
                            <?= __("Taxes & Fees"); ?>  <span><?= changeFormat(number_format($tt_tax, 2)); ?> AOA</span>
                                                        </div>-->
                            <div class="total-charges">
                                <?= __("Total Price"); ?> <span><?= changeFormat(number_format($tt_cost, 2)); ?> AOA</span>
                            </div>
                        </div>
